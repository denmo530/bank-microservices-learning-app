package com.demor.loans.exception;

import com.demor.loans.dto.ErrorDto;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorDto> handleLoanAlreadyExistsException(LoanAlreadyExistsException exception,
                                                                                 WebRequest webRequest){
        ErrorDto errorResponseDTO = new ErrorDto(
                exception.getMessage(),
                webRequest.getDescription(false),
